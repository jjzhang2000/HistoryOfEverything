...
// Flare import commented out for null safety migration
...
class _TimelineWidgetState extends State<TimelineWidget> {
  ...
  void _scaleUpdate(ScaleUpdateDetails details) {
    ...
    if (context.size == null || _lastFocalPoint == null) return;
    double scale =
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            IconButton(
                              ...
                              color: _headerTextColor ?? Colors.black.withValues(alpha: 0.5),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  ...
                                  fontSize: 20.0,
                                  color: _headerTextColor ?? darkText.withValues(
                                          alpha: darkText.a * 0.75)),
                            ),
                            Expanded(
                              child: HeartIconButton(
                                isActive: _showFavorites,
                                color: _headerTextColor ?? darkText
